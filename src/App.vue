...
<style lang="scss">
  ...
  .heading__title__input__text { font-size: 23px; font-weight: 600; outline: none; }
  .heading__title__input__icon { margin: 4px 10px 3px; flex-shrink: 0; }

  .flip-move { transition: all .5s;}
</style>
