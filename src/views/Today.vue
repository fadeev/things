    ...
    <div :class="['area__container', {'area__container_expanded': expanded}]" @click="expanded = null; selected = null">
      <div class="background" v-if="todoList.length <= 0">
        <div class="background__image">
          <svg class="" xmlns="http://www.w3.org/2000/svg" fill="#f5f6f6" width="84" height="84" viewBox="0 0 24 24"><path d="M12 .587l3.668 7.568 8.332 1.151-6.064 5.828 1.48 8.279-7.416-3.967-7.417 3.967 1.481-8.279-6.064-5.828 8.332-1.151z"/></svg>
        </div>
      </div>
      <div class="heading__title">
        <svg class="heading__title__icon" xmlns="http://www.w3.org/2000/svg" fill="#f1ca00" width="24" height="24" viewBox="0 0 24 24"><path d="M12 .587l3.668 7.568 8.332 1.151-6.064 5.828 1.48 8.279-7.416-3.967-7.417 3.967 1.481-8.279-6.064-5.828 8.332-1.151z"/></svg>
        <div class="heading__title__input">
          <span class="heading__title__input__text">Today</span>
        </div>
      </div>
    ...
    computed: {
      todoList() {
        ...
        return this.$store.state.entityList.filter(entity => {
          return entity.type == 'todo' && entity.date == today
        })
      },
    },
    methods: {
